...
CalendarDateSelect.prototype = {
  ...
  refreshCalendarGrid: function () {
    ...
    hdc = this.options.get("highlighted_date_check");
    for (var cell_index = 0;cell_index<42; cell_index++)
    {
      ...
      if (hdc) { if (hdc(iterator.stripTime())) cell.addClassName("highlighted"); else cell.removeClassName("highlighted") };
